    ...
    if (bookings.length === 0) {
        bookingsList.innerHTML = `
            <div class="no-events">
                ...
                <button class="btn btn-small" onclick="showHome()" style="padding: 0.5rem 1.5rem; font-size: 0.875rem; width: auto; display: inline-block; font-weight: 500;">
        ...
        return `
            <div class="event-card" onclick="showEventDetails('${event.id}')">
                ...
                <div class="card-footer">
                    <button class="btn" onclick="event.stopPropagation(); showEventDetails('${event.id}')">
                        Browse Events
                    </button>
                </div>
            </div>
